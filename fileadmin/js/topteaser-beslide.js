...
(  '../../fileadmin/images/logoslideshow-krhb-48x48.png',
   '../../fileadmin/images/logoslideshow-fodi-48x48.png',
   '../../fileadmin/images/logoslideshow-gig-48x48.png', 
   '../../fileadmin/images/logoslideshow-lgsp-48x48.png',    
   '../../fileadmin/images/logoslideshow-gtgt-48x48.png',
   '../../fileadmin/images/logoslideshow-mpex-48x48.png',
   '../../fileadmin/images/logoslideshow-pmps-48x48.png',
   '../../fileadmin/images/logoslideshow-keds-48x48.png',
   '../../fileadmin/images/logoslideshow-csrf-48x48.png'
);
var def_divid="topTeaserSlideShow"; //the id of the div container that will hold the slideshow
var def_picwid=48; //set this to the width of your widest pic
var def_pichei=48; //... and this to the height of your highest pic
var def_backgr="#fec"; //set this to the background color you want to use for the slide-area
//(for example the body-background-color) if your pics are of different size
var def_sdur=1; //time to show a pic between fades in seconds
